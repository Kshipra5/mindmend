...
# Put your MongoDB connection string inside the quotes
client = MongoClient("mongodb+srv://mindmend_user:Mindmend26!@cluster0.jdr0utq.mongodb.net/?appName=Cluster0")
